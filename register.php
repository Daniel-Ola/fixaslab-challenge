            ...
            <div class="row">
                <div class="col-6 offset-lg-3 mt-5">
                    <div class="card mt-5" style="padding: 0 15px 20px 15px;">
                        <h3 class="text-center text-info mt-4">Register</h3>
                        <?php
                            if(isset($_SESSION['regerror'])){
                        ?>
                        <div class="col-4 offset-lg-4 alert alert-info"><?= $_SESSION['regerror'] ?></div>
                        <?php
                            }
                        ?>
                        <form action="php/actionmanager.php" method="post">
                            ...
                            <p class="text-center text-info mt-4">Already have an account? <a href="login.php">Sign in here</a></p>
                        </form>
                    </div>
